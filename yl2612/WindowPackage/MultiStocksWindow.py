...
import StocksPackage.MultiStocksComparison as MSC
import pandas as pd
import datetime
...
class MultiStocksWindow:
	...
	def plot(self, stock_list, start_date, end_date):
		...
		except (StockNameInputException,DateInputException,EmptyInputException,ConnectInternetException,DateRangeException,EndDateException) as error:
