...
from Tkinter import *
import ttk
import StocksPackage.StockClass as SC
import pandas as pd
import datetime
import tkMessageBox
import StocksPackage.PortfolioClass as PC
...
class PortfolioAnalysisWindow:
	...
	def plot(self, stock_list, amount_list, start_date, end_date):
		...
		except (StockNameInputException,DateInputException,EmptyInputException,ConnectInternetException,DateRangeException, TradeAmountException,EmptyPortfolioException,EndDateException) as error:
